<!-- FOOTER.begin -->
<footer class="bd-footer py-0 mt-1 bg-light">
      ...
      <div class="row">
        <div class="col-lg-3 mb-3">
          ...
          <ul class="list-unstyled small text-muted">
            <li class="mb-2">Разработано и построено со всей любовью к миру <a href="/docs/5.1/about/team/">командой Bootstrap</a> с помощью <a href="https://github.com/twbs/bootstrap/graphs/contributors" rel="nofollow noopener" target="_blank">наших участников</a>.</li>
            <li class="mb-2">Код распространяется по лицензии <a href="https://github.com/twbs/bootstrap/blob/main/LICENSE" target="_blank" rel="license noopener">MIT</a>, документация по лицензии <a href="https://creativecommons.org/licenses/by/3.0/" target="_blank" rel="license noopener">CC BY 3.0</a>.</li>
        ...
        <div class="col-6 col-lg-2 offset-lg-1 mb-3">
          ...
          <ul class="list-unstyled">
            <li class="mb-2"><a href="/">В начало</a></li>
