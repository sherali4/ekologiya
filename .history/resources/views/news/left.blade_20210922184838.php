<div class="list-group">
    ...
    <button type="button" class="list-group-item list-group-item-action text-center active bg-secondary"><h4>Yangiliklar</h4></button>
    <button type="button" class="list-group-item list-group-item-action">Barcha yangiliklar</button>
    ...
    <button type="button" class="list-group-item list-group-item-action disabled">Hududiy bo'limlar yangiliklari</button>
</div>
